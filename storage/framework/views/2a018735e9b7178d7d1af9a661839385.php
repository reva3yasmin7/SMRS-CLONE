      ...
      <!-- End Welcome Hero Screen -->
            ...
            <div class="mt-8 bg-white p-6 rounded-2xl shadow-md border border-gray-300">
                ...
                <div class="flex justify-center gap-10 mt-4">
                    <div onclick="location.href='<?php echo e(route('ajuanruang')); ?>'" class="bg-[#38A6D6] px-4 py-6 w-[40%] rounded-2xl text-right cursor-pointer">
                        <h1 class="text-2xl text-center font-bold">40</h1>
                        <h1 class="text-center">Pengajuan Ruangan</h1>
                    </div>
                    <div onclick="location.href='<?php echo e(route('ajuanjadwal')); ?>'" class="bg-[#2ACD7F] px-4 py-6 w-[40%] rounded-2xl text-right cursor-pointer">
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dover\Downloads\SMRS-CLONE\SMRS-CLONE\resources\views/dkDashboard.blade.php ENDPATH**/ ?>