        ...
        <div id="main-content" class="w-4/5 bg-red-300 p-8 overflow-y-auto h-screen ml-[20%]">
            <div class="flex justify-between items-start">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-100">
                                        <td class="py-4 px-6"><?php echo e($loop->iteration); ?></td>
                                        <td class="py-4 px-6"><?php echo e($jadwal->matakuliah); ?> <?php echo e($jadwal->kelas); ?></td>
                                        <td class="py-4 px-6"><?php echo e($jadwal->hari); ?></td>
                                        <td class="py-4 px-6"><?php echo e($jadwal->jammulai); ?> - <?php echo e($jadwal->jamselesai); ?></td>
                                        <td class="py-4 px-6"><?php echo e($jadwal->ruang); ?></td>
                                        <td class="py-4 px-6"><?php echo e($jadwal->kapasitas); ?></td>
                                        <td class="py-4 px-6">
                                            <button type="button" data-modal-target="updateModal-<?php echo e($jadwal->id); ?>" data-modal-toggle="updateModal-<?php echo e($jadwal->id); ?>" class="text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5">
                                                Edit
                                            </button>
                                        </td>
                                        <td class="py-4 px-6">
                                            <span class="<?php echo e($jadwal->status == 'Pending' ? 'bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full' : 
                                                ($jadwal->status == 'Disetujui' ? 'bg-green-100 text-green-800 px-3 py-1 rounded-full' : 'bg-red-100 text-red-800 px-3 py-1 rounded-full')); ?>"><?php echo e($jadwal->status); ?>
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div id="updateModal-<?php echo e($jadwal->id); ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                    ...
                                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="updateModal-<?php echo e($jadwal->id); ?>">
                                ...
                                <!-- Modal Edit Jadwal -->
                                <form class="p-4 md:p-5" action = "buatjadwal/<?php echo e($jadwal->id); ?>" method = "POST">
                                    <?php echo csrf_field(); ?>
                                    <div id = "alerta-<?php echo e($jadwal->id); ?>">
                                    </div>
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-1 ">
                                            <label for="hari" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hari</label>
                                            <select id="hari-<?php echo e($jadwal->id); ?>" name="hari" data-id="<?php echo e($jadwal->id); ?>" class="hari bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        ...
                                        <div class="col-span-1 ">
                                            ...
                                            <select id="ruang-<?php echo e($jadwal->id); ?>" name="ruang" data-id="<?php echo e($jadwal->id); ?>" class="ruang bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                                <option selected="">Ruang</option>
                                                <?php $__currentLoopData = $dataruang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($ruang->noruang); ?>"><?php echo e($ruang->noruang); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-span-1 ">
                                            <label for="jam" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam Mulai</label>
                                            <select id="jam-<?php echo e($jadwal->id); ?>" name="jammulai" data-id="<?php echo e($jadwal->id); ?>" class="jam bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dover\Downloads\SMRS-CLONE\SMRS-CLONE\resources\views/kpBuatJadwal.blade.php ENDPATH**/ ?>